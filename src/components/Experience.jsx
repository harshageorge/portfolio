      ...
      <div className="pt-10 md:pb-4 pb-2">
        ...
        {nav?'hidden':(
             ...
             <li class="mb-4 ml-2 md:mb-10 md:ml-6">
                 <span class="absolute flex items-center justify-center w-4 h-4 md:w-6 md:h-6 bg-blue-100 rounded-full -left-2 md:-left-3 ring-8 md:top-6 ring-white dark:ring-gray-900 dark:bg-blue-900">
                   <svg
                     fill="none"
                     stroke="currentColor"
                     stroke-width="1.5"
